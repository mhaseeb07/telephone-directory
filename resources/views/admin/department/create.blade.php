...
<div class="container-fluid">
    <div class="d-flex justify-content-between py-4">
        ...
        <a class="btn btn-sm btn-warning" href="{{route('department.create')}}">View All</a>
    </div>
                    ...
                    <form action="{{route('department.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-3">
                                ...
                                <input type="text" placeholder="Enter Department Name" class="form-control rounded-0" name="name" value="{{old('name')}}">
                            </div>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between py-4">
        ...
        <a class="btn btn-sm btn-success" href="{{route('department.create')}}">Add New</a>
    </div>
    <div class="card rounded-0">
        <div class="card-body">
            ...
            columnDefs: [
                {
                    ...
                    render: function (data,type,row,meta) {
                        ...
                        var sdel ='{{ route("department.destroy", ":id") }}';
